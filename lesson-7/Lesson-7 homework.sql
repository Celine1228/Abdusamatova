...
AS [7ID SALES] FROM Sales
where ProductID=7
--Question 6
select * from Employees
Select AVG(Age) as [av.age] from Employees
--Question 7
...
select*from Sales
select CustomerID,
sum(SaleAmount) as salesperperson
from sales
group by CustomerID
--qUESTION 10
SELECT*FROM EMPLOYEES
...
--Question 11
select ProductID, sum(SaleAmount) as [Total sales], avg(SaleAmount) as [Average sales]
from sales
group by ProductID
--Question 12
Select * from Employees
Select DepartmentName, count(EmployeeID) as [NUMBEROFEMP]
FROM EMPLOYEES GROUP BY DepartmentName HAVING DepartmentName='HR'
--Question 13
Select DepartmentName, max(Salary) as boy, min(Salary) as bechara
from Employees
group by DepartmentName

--Question 14
Select DepartmentName, avg(Salary) as average
from Employees
group by DepartmentName
--Question 15
Select count(DepartmentName) as [Employees per dep],DepartmentName, avg(Salary) as average
from Employees
group by DepartmentName
--Question 16
...
--Question 19
Select Departmentname, avg(salary) from employees group by DepartmentName having avg(salary)>60000
--Question 20
...
--Question 22
Select Departmentname, avg(salary) as averagesal, sum(salary) as totalsal from employees group by DepartmentName having avg(salary)>65000
--Question 23
SELECT CustomerID,
    SUM(CASE WHEN TotalAmount > 50 THEN TotalAmount ELSE 0 END) AS TotalSalesOver50,
