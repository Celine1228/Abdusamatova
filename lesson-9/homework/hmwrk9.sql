...
--Question 3
select P.Productname, s.Suppliername, P.SupplierID from Products as P
...
--Question 5
select *from courses
select Students.Name, courses.Coursename from Courses cross join Students
--Question 6
select*from products
select*from orders
select products.productname, orders.orderid, products.productid from Products
inner join orders on orders.productid=products.ProductID
--question 7
select*from departments 
select*from Employees
select Departments.departmentid, departments.departmentname, employees.[name] from Departments
inner join Employees on employees.departmentid=departments.departmentid
--question 8
select*from Enrollments
select*from students
select students.StudentId, enrollments.courseid, students.[name] from enrollments 
...
select*from orders
select*from products
select orders.ProductID, orders.orderid, products.price from orders
inner join products on 
orders.productid=products.productid where products.price>100
...
select*from employees
select*from departments
select employees.departmentid, employees.[name], departments.departmentname from employees
cross join departments where employees.departmentid<>departments.DepartmentID
--question 12
select*from Products
select*from orders
select products.productid, orders.quantity, products.stockquantity from products
inner join orders on orders.productid=products.productid where orders.quantity>products.StockQuantity
--question 13
select*from customers
select*from sales
select c.firstname, c.firstname, sales.productid, c.customerid from customers as c
inner join sales on c.CustomerID=sales.customerid where SaleAmount>=500
--question 14
select*from courses
select*from enrollments
select*from students

select courses.coursename, students.[name] from courses inner join enrollments 
...
select products.productname, suppliers.suppliername from products inner join suppliers
on products.supplierid=suppliers.supplierid where Suppliers.supplierName like '%Tech%'
--QUESTION 16
Select*from orders
select*from payments
select orders.TotalAmount, payments.amount from orders inner join payments 
on orders.orderid=payments.orderid where Amount<TotalAmount
--question 17
select*from employees
select*from departments
select employees.name, departments.departmentname from employees inner join departments
...
--question 19
select*from customers
SELECT Sales.CustomerID, customers.country
from Sales
...
--question 24 
select Employees.EmployeeID, Employees.Name, Employees.DepartmentID, Employees.Salary
from Employees
...
--question 25
select*from customers
select Customers.CustomerID, Customers.FirstName+'  '+LastName as fullname, Orders.OrderID
from Orders
